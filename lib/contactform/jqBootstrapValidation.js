      ...
      methods: {
        init: function (o) {
          ...
          return a(l).bind('submit', function (e) {
            ...
            i ? (r.options.preventSubmit && e.preventDefault(), t.addClass('error'), a.isFunction(r.options.submitError) && r.options.submitError(t, e, n.jqBootstrapValidation('collectErrors', !0))) : (t.removeClass('error'), a.isFunction(r.options.submitSuccess) && r.options.submitSuccess(t, e))
          }),
          this.each(function () {
            var t = a(this),
            ...
            if (!l.length && r.options.autoAdd && r.options.autoAdd.helpBlocks && (l = a('<div class="help-block" />'), o.find('.controls').append(l), e.push(l[0])), r.options.sniffHtml) {
              ...
              void 0 !== t.attr('maxlength') && (c = 'Too long: Maximum of \'' + t.attr('maxlength') + '\' characters<!-- data-validation-maxlength-message to override -->', t.data('validationMaxlengthMessage') && (c = t.data('validationMaxlengthMessage')), t.data('validationMaxlengthMessage', c), t.data('validationMaxlengthMaxlength', t.attr('maxlength'))),
              void 0 !== t.attr('minlength') && (c = 'Too short: Minimum of \'' + t.attr('minlength') + '\' characters<!-- data-validation-minlength-message to override -->', t.data('validationMinlengthMessage') && (c = t.data('validationMinlengthMessage')), t.data('validationMinlengthMessage', c), t.data('validationMinlengthMinlength', t.attr('minlength'))),
              void 0 === t.attr('required') && void 0 === t.attr('aria-required') || (c = r.builtInValidators.required.message, t.data('validationRequiredMessage') && (c = t.data('validationRequiredMessage')), t.data('validationRequiredMessage', c)),
              void 0 !== t.attr('type') && 'number' === t.attr('type').toLowerCase() && (c = r.builtInValidators.number.message, t.data('validationNumberMessage') && (c = t.data('validationNumberMessage')), t.data('validationNumberMessage', c)),
              void 0 !== t.attr('type') && 'email' === t.attr('type').toLowerCase() && (c = 'Not a valid email address<!-- data-validator-validemail-message to override -->', t.data('validationValidemailMessage') ? c = t.data('validationValidemailMessage') : t.data('validationEmailMessage') && (c = t.data('validationEmailMessage')), t.data('validationValidemailMessage', c)),
              void 0 !== t.attr('minchecked') && (c = 'Not enough options checked; Minimum of \'' + t.attr('minchecked') + '\' required<!-- data-validation-minchecked-message to override -->', t.data('validationMincheckedMessage') && (c = t.data('validationMincheckedMessage')), t.data('validationMincheckedMessage', c), t.data('validationMincheckedMinchecked', t.attr('minchecked'))),
              void 0 !== t.attr('maxchecked') && (c = 'Too many options checked; Maximum of \'' + t.attr('maxchecked') + '\' required<!-- data-validation-maxchecked-message to override -->', t.data('validationMaxcheckedMessage') && (c = t.data('validationMaxcheckedMessage')), t.data('validationMaxcheckedMessage', c), t.data('validationMaxcheckedMaxchecked', t.attr('maxchecked')))
            }
            ...
            a.each(d, function (e, n) {
              ...
              if (o = o || '\'' + n + '\' validation failed <!-- Add attribute \'data-validation-' + n.toLowerCase() + '-message\' to input to change this message -->', a.each(r.validatorTypes, function (e, r) {
                ...
                'shortcut' === c ? s = !0 : a.each(r.validatorTypes, function (e, o) {
                  ...
                  s || c !== e.toLowerCase() || (t.data('validation' + n + i(o.name), d[o.name.toLowerCase()]), h[c].push(a.extend(d, o.init(t, n))), s = !0)
                })
              }
            ...
            'keydown',
            'keypress',
            'change'].join('.validation ') + '.validation', function (e, i) {
              var d = n(t),
              c = [
              ];
